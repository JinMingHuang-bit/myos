...
# main.c:20:     cr4 |= (1 << 9);  // 设置OSXMMEXCPT位
	orq	$512, -24(%rbp)	#, cr4
...
# main.c:31:     Pos.FB_addr=(int *)0xffff800000a00000;
	...
	movq	%rsi, 24(%rbx,%rax)	# tmp120, Pos.FB_addr
...
# main.c:66:     color_printk(YELLOW,BLACK,"hello\t\t kernel!\n");
	...
	call	*%rcx	# tmp102
# main.c:67:     color_printk(YELLOW,BLACK,"hello,User\n");
	...
	call	*%rcx	# tmp105
# main.c:68:     color_printk(YELLOW,BLACK,"Standing firm in the universe and cosmos, I have established the paradise of Eden.\n");
...
# main.c:69:     color_printk(YELLOW,BLACK,"I am the king of the world, the creator of the universe, and the destroyer of all evil.\n");
	...
	movq	%rbx, %r15	# tmp82,
	movl	$0, %eax	#,
	movabsq	$color_printk@PLTOFF, %rcx	#, tmp111
	addq	%rbx, %rcx	# tmp82, tmp111
	call	*%rcx	# tmp111
# main.c:70:     color_printk(YELLOW,BLACK,"I am the royal daughter who has broken the law!\n");
	movabsq	$.LC4@GOTOFF, %rax	#, tmp113
	...
	movq	%rbx, %r15	# tmp82,
	movl	$0, %eax	#,
	movabsq	$color_printk@PLTOFF, %rcx	#, tmp114
	addq	%rbx, %rcx	# tmp82, tmp114
	call	*%rcx	# tmp114
# main.c:72:     color_printk(YELLOW,BLACK,"Hmm,there is still a problem here?");
	movabsq	$.LC5@GOTOFF, %rax	#, tmp116
	leaq	(%rbx,%rax), %rax	#, tmp115
	movq	%rax, %rdx	# tmp115,
	movl	$0, %esi	#,
	movl	$16776960, %edi	#,
	movq	%rbx, %r15	# tmp82,
	movl	$0, %eax	#,
	movabsq	$color_printk@PLTOFF, %rcx	#, tmp117
	addq	%rbx, %rcx	# tmp82, tmp117
	call	*%rcx	# tmp117
.L2:
# main.c:73:     while (1)
	nop	
