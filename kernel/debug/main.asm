...
0000000000000000 <Start_Kernel>:
 ...
 198:	00 00 00 
 19b:	48 8d 04 03          	lea    (%rbx,%rax,1),%rax
 19f:	48 89 c2             	mov    %rax,%rdx
 1a2:	be 00 00 00 00       	mov    $0x0,%esi
 1a7:	bf 00 ff ff 00       	mov    $0xffff00,%edi
 1ac:	49 89 df             	mov    %rbx,%r15
 1af:	b8 00 00 00 00       	mov    $0x0,%eax
 1b4:	48 b9 00 00 00 00 00 	movabs $0x0,%rcx
 1bb:	00 00 00 
 1be:	48 01 d9             	add    %rbx,%rcx
 1c1:	ff d1                	call   *%rcx
 1c3:	48 b8 00 00 00 00 00 	movabs $0x0,%rax
 1ca:	00 00 00 
 1cd:	48 8d 04 03          	lea    (%rbx,%rax,1),%rax
 1d1:	48 89 c2             	mov    %rax,%rdx
 1d4:	be 00 00 00 00       	mov    $0x0,%esi
 1d9:	bf 00 ff ff 00       	mov    $0xffff00,%edi
 1de:	49 89 df             	mov    %rbx,%r15
 1e1:	b8 00 00 00 00       	mov    $0x0,%eax
 1e6:	48 b9 00 00 00 00 00 	movabs $0x0,%rcx
 1ed:	00 00 00 
 1f0:	48 01 d9             	add    %rbx,%rcx
 1f3:	ff d1                	call   *%rcx
 1f5:	48 b8 00 00 00 00 00 	movabs $0x0,%rax
 1fc:	00 00 00 
 1ff:	48 8d 04 03          	lea    (%rbx,%rax,1),%rax
 203:	48 89 c2             	mov    %rax,%rdx
 206:	be 00 00 00 00       	mov    $0x0,%esi
 20b:	bf 00 ff ff 00       	mov    $0xffff00,%edi
 210:	49 89 df             	mov    %rbx,%r15
 213:	b8 00 00 00 00       	mov    $0x0,%eax
 218:	48 b9 00 00 00 00 00 	movabs $0x0,%rcx
 21f:	00 00 00 
 222:	48 01 d9             	add    %rbx,%rcx
 225:	ff d1                	call   *%rcx
 227:	90                   	nop
 228:	eb fd                	jmp    227 <Start_Kernel+0x227>
