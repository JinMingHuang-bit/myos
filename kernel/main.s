...
.L11:
	...
	addq	%r11, %rax	#, tmp82
# main.c:13:     int *addr=(int *)0xffff800000a00000;
	movabsq	$-140737477869568, %rax	#, tmp112
	movq	%rax, -8(%rbp)	# tmp112, addr
# main.c:15:     for(i=0;i<640*20;i++){
	movl	$0, -12(%rbp)	#, i
# main.c:15:     for(i=0;i<640*20;i++){
	jmp	.L2	#
.L3:
# main.c:16:         *((char*)addr+0)=(char)0x00;
	movq	-8(%rbp), %rax	# addr, tmp95
	movb	$0, (%rax)	#, MEM[(char *)addr_13]
# main.c:17:         *((char*)addr+1)=(char)0x00;
	movq	-8(%rbp), %rax	# addr, tmp96
	addq	$1, %rax	#, _1
# main.c:17:         *((char*)addr+1)=(char)0x00;
	movb	$0, (%rax)	#, *_1
# main.c:18:         *((char*)addr+2)=(char)0xff;
	movq	-8(%rbp), %rax	# addr, tmp97
	addq	$2, %rax	#, _2
# main.c:18:         *((char*)addr+2)=(char)0xff;
	movb	$-1, (%rax)	#, *_2
# main.c:19:         *((char*)addr+3)=(char)0x00;
	movq	-8(%rbp), %rax	# addr, tmp98
	addq	$3, %rax	#, _3
# main.c:19:         *((char*)addr+3)=(char)0x00;
	movb	$0, (%rax)	#, *_3
# main.c:20:         addr=addr+1;
	addq	$4, -8(%rbp)	#, addr
# main.c:15:     for(i=0;i<640*20;i++){
	addl	$1, -12(%rbp)	#, i
.L2:
# main.c:15:     for(i=0;i<640*20;i++){
	cmpl	$12799, -12(%rbp)	#, i
	jle	.L3	#,
# main.c:23:     for(i=0;i<640*20;i++){
	movl	$0, -12(%rbp)	#, i
# main.c:23:     for(i=0;i<640*20;i++){
	jmp	.L4	#
.L5:
# main.c:24:         *((char*)addr+0)=(char)0x00;
	movq	-8(%rbp), %rax	# addr, tmp99
	movb	$0, (%rax)	#, MEM[(char *)addr_14]
# main.c:25:         *((char*)addr+1)=(char)0xff;
	movq	-8(%rbp), %rax	# addr, tmp100
	addq	$1, %rax	#, _4
# main.c:25:         *((char*)addr+1)=(char)0xff;
	movb	$-1, (%rax)	#, *_4
# main.c:26:         *((char*)addr+2)=(char)0x00;
	movq	-8(%rbp), %rax	# addr, tmp101
	addq	$2, %rax	#, _5
# main.c:26:         *((char*)addr+2)=(char)0x00;
	movb	$0, (%rax)	#, *_5
# main.c:27:         *((char*)addr+3)=(char)0x00;
	movq	-8(%rbp), %rax	# addr, tmp102
	addq	$3, %rax	#, _6
# main.c:27:         *((char*)addr+3)=(char)0x00;
	movb	$0, (%rax)	#, *_6
# main.c:28:         addr=addr+1;
	addq	$4, -8(%rbp)	#, addr
# main.c:23:     for(i=0;i<640*20;i++){
	addl	$1, -12(%rbp)	#, i
.L4:
# main.c:23:     for(i=0;i<640*20;i++){
	cmpl	$12799, -12(%rbp)	#, i
	jle	.L5	#,
# main.c:31:     for(i=0;i<640*20;i++){
	movl	$0, -12(%rbp)	#, i
# main.c:31:     for(i=0;i<640*20;i++){
	jmp	.L6	#
.L7:
# main.c:32:         *((char*)addr+0)=(char)0xff;
	movq	-8(%rbp), %rax	# addr, tmp103
	movb	$-1, (%rax)	#, MEM[(char *)addr_15]
# main.c:33:         *((char*)addr+1)=(char)0x00;
	movq	-8(%rbp), %rax	# addr, tmp104
	addq	$1, %rax	#, _7
# main.c:33:         *((char*)addr+1)=(char)0x00;
	movb	$0, (%rax)	#, *_7
# main.c:34:         *((char*)addr+2)=(char)0x00;
	movq	-8(%rbp), %rax	# addr, tmp105
	addq	$2, %rax	#, _8
# main.c:34:         *((char*)addr+2)=(char)0x00;
	movb	$0, (%rax)	#, *_8
# main.c:35:         *((char*)addr+3)=(char)0x00;
	movq	-8(%rbp), %rax	# addr, tmp106
	addq	$3, %rax	#, _9
# main.c:35:         *((char*)addr+3)=(char)0x00;
	movb	$0, (%rax)	#, *_9
# main.c:36:         addr=addr+1;
	addq	$4, -8(%rbp)	#, addr
# main.c:31:     for(i=0;i<640*20;i++){
	addl	$1, -12(%rbp)	#, i
.L6:
# main.c:31:     for(i=0;i<640*20;i++){
	cmpl	$12799, -12(%rbp)	#, i
	jle	.L7	#,
# main.c:38:     for(i=0;i<640*20;i++){
	movl	$0, -12(%rbp)	#, i
# main.c:38:     for(i=0;i<640*20;i++){
	jmp	.L8	#
.L9:
# main.c:39:         *((char*)addr+0)=(char)0xff;
	movq	-8(%rbp), %rax	# addr, tmp107
	movb	$-1, (%rax)	#, MEM[(char *)addr_16]
# main.c:40:         *((char*)addr+1)=(char)0xff;
	movq	-8(%rbp), %rax	# addr, tmp108
	addq	$1, %rax	#, _10
# main.c:40:         *((char*)addr+1)=(char)0xff;
	movb	$-1, (%rax)	#, *_10
# main.c:41:         *((char*)addr+2)=(char)0xff;
	movq	-8(%rbp), %rax	# addr, tmp109
	addq	$2, %rax	#, _11
# main.c:41:         *((char*)addr+2)=(char)0xff;
	movb	$-1, (%rax)	#, *_11
# main.c:42:         *((char*)addr+3)=(char)0x00;
	movq	-8(%rbp), %rax	# addr, tmp110
	addq	$3, %rax	#, _12
# main.c:42:         *((char*)addr+3)=(char)0x00;
	movb	$0, (%rax)	#, *_12
# main.c:43:         addr=addr+1;
	addq	$4, -8(%rbp)	#, addr
# main.c:38:     for(i=0;i<640*20;i++){
	addl	$1, -12(%rbp)	#, i
.L8:
