...
ffff800000104006:	31 f6                	xor    %esi,%esi
ffff800000104008:	49 bb 9c 4c 00 00 00 	movabs $0x4c9c,%r11
ffff80000010400f:	00 00 00 
ffff800000104012:	4c 8d 3d eb ff ff ff 	lea    -0x15(%rip),%r15        # ffff800000104004 <Start_Kernel+0x4>
ffff800000104019:	53                   	push   %rbx
ffff80000010401a:	4d 01 df             	add    %r11,%r15
ffff80000010401d:	48 ba 50 c7 ff ff ff 	movabs $0xffffffffffffc750,%rdx
ffff800000104024:	ff ff ff 
ffff800000104027:	48 b8 20 10 00 00 00 	movabs $0x1020,%rax
ffff80000010402e:	00 00 00 
ffff800000104031:	48 b9 00 00 a0 00 00 	movabs $0xffff800000a00000,%rcx
ffff800000104038:	80 ff ff 
ffff80000010403b:	bf 00 ff ff 00       	mov    $0xffff00,%edi
ffff800000104040:	48 bb 60 c2 ff ff ff 	movabs $0xffffffffffffc260,%rbx
ffff800000104047:	ff ff ff 
ffff80000010404a:	4c 01 fb             	add    %r15,%rbx
ffff80000010404d:	48 83 ec 08          	sub    $0x8,%rsp
ffff800000104051:	66 41 0f 6f 04 17    	movdqa (%r15,%rdx,1),%xmm0
ffff800000104057:	4a 89 4c 38 18       	mov    %rcx,0x18(%rax,%r15,1)
ffff80000010405c:	48 ba 60 c7 ff ff ff 	movabs $0xffffffffffffc760,%rdx
ffff800000104063:	ff ff ff 
ffff800000104066:	49 c7 44 07 20 00 1a 	movq   $0x4f1a00,0x20(%r15,%rax,1)
ffff80000010406d:	4f 00 
ffff80000010406f:	49 8b 14 17          	mov    (%r15,%rdx,1),%rdx
ffff800000104073:	41 0f 29 04 07       	movaps %xmm0,(%r15,%rax,1)
ffff800000104078:	49 89 54 07 10       	mov    %rdx,0x10(%r15,%rax,1)
ffff80000010407d:	48 b8 29 c6 ff ff ff 	movabs $0xffffffffffffc629,%rax
ffff800000104084:	ff ff ff 
ffff800000104087:	49 8d 14 07          	lea    (%r15,%rax,1),%rdx
ffff80000010408b:	31 c0                	xor    %eax,%eax
ffff80000010408d:	ff d3                	call   *%rbx
ffff80000010408f:	31 f6                	xor    %esi,%esi
ffff800000104091:	bf 00 ff ff 00       	mov    $0xffff00,%edi
ffff800000104096:	48 b8 3a c6 ff ff ff 	movabs $0xffffffffffffc63a,%rax
ffff80000010409d:	ff ff ff 
ffff8000001040a0:	49 8d 14 07          	lea    (%r15,%rax,1),%rdx
ffff8000001040a4:	31 c0                	xor    %eax,%eax
ffff8000001040a6:	ff d3                	call   *%rbx
ffff8000001040a8:	31 f6                	xor    %esi,%esi
ffff8000001040aa:	bf 00 ff ff 00       	mov    $0xffff00,%edi
ffff8000001040af:	48 b8 48 c6 ff ff ff 	movabs $0xffffffffffffc648,%rax
ffff8000001040b6:	ff ff ff 
ffff8000001040b9:	49 8d 14 07          	lea    (%r15,%rax,1),%rdx
ffff8000001040bd:	31 c0                	xor    %eax,%eax
ffff8000001040bf:	ff d3                	call   *%rbx
ffff8000001040c1:	31 f6                	xor    %esi,%esi
ffff8000001040c3:	bf 00 ff ff 00       	mov    $0xffff00,%edi
ffff8000001040c8:	48 b8 a0 c6 ff ff ff 	movabs $0xffffffffffffc6a0,%rax
ffff8000001040cf:	ff ff ff 
ffff8000001040d2:	49 8d 14 07          	lea    (%r15,%rax,1),%rdx
ffff8000001040d6:	31 c0                	xor    %eax,%eax
ffff8000001040d8:	ff d3                	call   *%rbx
ffff8000001040da:	31 f6                	xor    %esi,%esi
ffff8000001040dc:	bf 00 ff ff 00       	mov    $0xffff00,%edi
ffff8000001040e1:	48 b8 d8 c6 ff ff ff 	movabs $0xffffffffffffc6d8,%rax
ffff8000001040e8:	ff ff ff 
ffff8000001040eb:	49 8d 14 07          	lea    (%r15,%rax,1),%rdx
ffff8000001040ef:	31 c0                	xor    %eax,%eax
ffff8000001040f1:	ff d3                	call   *%rbx
ffff8000001040f3:	eb fe                	jmp    ffff8000001040f3 <Start_Kernel+0xf3>
ffff8000001040f5:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
ffff8000001040fc:	00 00 00 
ffff8000001040ff:	90                   	nop
